#!/bin/bash
#SBATCH --job-name=SDSS_J131706.19+2714_UL_20240411
#SBATCH --partition=pi_mingarelli
#SBATCH --exclude=r806u23n04
#SBATCH --output=/home/bbl29/targeted_cws_ng15/logs/SDSS_J131706.19+2714_UL_20240411.txt
#SBATCH --error=/home/bbl29/targeted_cws_ng15/logs/error/SDSS_J131706.19+2714_UL_20240411.txt
#SBATCH --nodes=1
#SBATCH --ntasks=4
