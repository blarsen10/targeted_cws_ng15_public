#!/bin/bash
#SBATCH --job-name=no_cw_varygwb_20240314
#SBATCH --partition=pi_mingarelli
#SBATCH --output=/home/bbl29/targeted_cws_ng15/logs/no_cw_varygwb_20240314.txt
#SBATCH --error=/home/bbl29/targeted_cws_ng15/logs/error/no_cw_varygwb_20240314.txt
#SBATCH --nodes=1
#SBATCH --ntasks=4
