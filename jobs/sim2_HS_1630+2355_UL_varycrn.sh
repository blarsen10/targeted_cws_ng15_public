#!/bin/bash
#SBATCH --job-name=sim2_HS_1630+2355_UL_varycrn_20240229
#SBATCH --partition=day
#SBATCH --output=/home/bbl29/targeted_cws_ng15/logs/sim2_HS_1630+2355_UL_varycrn_20240229.txt
#SBATCH --error=/home/bbl29/targeted_cws_ng15/logs/error/sim2_HS_1630+2355_UL_varycrn_20240229.txt
#SBATCH --nodes=1
#SBATCH --ntasks=4
