#!/bin/bash
#SBATCH --job-name=HS_0926+3608_UL_20240322
#SBATCH --partition=pi_mingarelli
#SBATCH --exclude=r806u23n04
#SBATCH --output=/home/bbl29/targeted_cws_ng15/logs/HS_0926+3608_UL_20240322.txt
#SBATCH --error=/home/bbl29/targeted_cws_ng15/logs/error/HS_0926+3608_UL_20240322.txt
#SBATCH --nodes=1
#SBATCH --ntasks=4
