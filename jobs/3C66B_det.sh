#!/bin/bash
#SBATCH --job-name=3C66B_det_20240320
#SBATCH --partition=scavenge
#SBATCH --output=/home/bbl29/targeted_cws_ng15/logs/3C66B_det_20240320.txt
#SBATCH --error=/home/bbl29/targeted_cws_ng15/logs/error/3C66B_det_20240320.txt
#SBATCH --nodes=1
#SBATCH --ntasks=4
