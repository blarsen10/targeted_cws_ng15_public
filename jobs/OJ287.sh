#!/bin/bash
#SBATCH --job-name=OJ287_20240220
#SBATCH --partition=day
#SBATCH --output=/home/bbl29/targeted_cws_ng15/logs/OJ287_20240220.txt
#SBATCH --error=/home/bbl29/targeted_cws_ng15/logs/error/OJ287_20240220.txt
#SBATCH --nodes=1
#SBATCH --ntasks=4
