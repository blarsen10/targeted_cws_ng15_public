#!/bin/bash
#SBATCH --job-name=HS1630_20240212
#SBATCH --partition=day
#SBATCH --output=/home/bbl29/targeted_cws_ng15/logs/HS1630_20240212.txt
#SBATCH --error=/home/bbl29/targeted_cws_ng15/logs/error/HS1630_20240212.txt
#SBATCH --nodes=1
#SBATCH --ntasks=4
