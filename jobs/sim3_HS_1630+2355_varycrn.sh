#!/bin/bash
#SBATCH --job-name=sim3_HS_1630+2355_varycrn_20240302
#SBATCH --partition=day
#SBATCH --output=/home/bbl29/targeted_cws_ng15/logs/sim3_HS_1630+2355_varycrn_20240302.txt
#SBATCH --error=/home/bbl29/targeted_cws_ng15/logs/error/sim3_HS_1630+2355_varycrn_20240302.txt
#SBATCH --nodes=1
#SBATCH --ntasks=4
