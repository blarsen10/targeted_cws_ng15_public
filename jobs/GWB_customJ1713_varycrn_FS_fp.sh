#!/bin/bash
#SBATCH --job-name=GWB_customJ1713_varycrn_FS_fp_20240513
#SBATCH --partition=scavenge
#SBATCH --exclude=r806u23n04
#SBATCH --output=/home/bbl29/targeted_cws_ng15/logs/GWB_customJ1713_varycrn_FS_fp_20240513.txt
#SBATCH --error=/home/bbl29/targeted_cws_ng15/logs/error/GWB_customJ1713_varycrn_FS_fp_20240513.txt
#SBATCH --nodes=1
#SBATCH --ntasks=4
