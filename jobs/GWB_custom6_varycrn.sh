#!/bin/bash
#SBATCH --job-name=GWB_custom6_varycrn_20240423
#SBATCH --partition=pi_mingarelli
#SBATCH --exclude=r806u23n04
#SBATCH --output=/home/bbl29/targeted_cws_ng15/logs/GWB_custom6_varycrn_20240423.txt
#SBATCH --error=/home/bbl29/targeted_cws_ng15/logs/error/GWB_custom6_varycrn_20240423.txt
#SBATCH --nodes=1
#SBATCH --ntasks=4
