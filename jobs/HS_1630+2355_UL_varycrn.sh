#!/bin/bash
#SBATCH --job-name=HS_1630+2355_UL_varycrn_20240302
#SBATCH --partition=pi_mingarelli
#SBATCH --output=/home/bbl29/targeted_cws_ng15/logs/HS_1630+2355_UL_varycrn_20240302.txt
#SBATCH --error=/home/bbl29/targeted_cws_ng15/logs/error/HS_1630+2355_UL_varycrn_20240302.txt
#SBATCH --nodes=1
#SBATCH --ntasks=4
