#!/bin/bash
#SBATCH --job-name=SDSS_J092911.35+2037_det_20240320
#SBATCH --partition=scavenge
#SBATCH --output=/home/bbl29/targeted_cws_ng15/logs/SDSS_J092911.35+2037_det_20240320.txt
#SBATCH --error=/home/bbl29/targeted_cws_ng15/logs/error/SDSS_J092911.35+2037_det_20240320.txt
#SBATCH --nodes=1
#SBATCH --ntasks=4
