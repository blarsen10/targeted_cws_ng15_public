#!/bin/bash
#SBATCH --job-name=NGC_3115_49nHz_det_{{RA_DEC}}_{{DATE}}
#SBATCH --partition=pi_mingarelli
#SBATCH --exclude=r806u23n04
#SBATCH --output=/home/bbl29/targeted_cws_ng15/logs/NGC_3115_49nHz_det_{{RA_DEC}}_{{DATE}}.txt
#SBATCH --error=/home/bbl29/targeted_cws_ng15/logs/error/NGC_3115_49nHz_det_{{RA_DEC}}_{{DATE}}.txt
#SBATCH --nodes=1
#SBATCH --ntasks=4
