#!/bin/bash
#SBATCH --job-name=ng15_sim_GWB_CW_Rohan_varycrn_20250606
#SBATCH --partition=scavenge
#SBATCH --exclude=r806u23n04
#SBATCH --output=/home/bbl29/targeted_cws_ng15/logs/ng15_sim_GWB_CW_Rohan_varycrn_20250606.txt
#SBATCH --error=/home/bbl29/targeted_cws_ng15/logs/error/ng15_sim_GWB_CW_Rohan_varycrn_20250606.txt
#SBATCH --nodes=1
#SBATCH --ntasks=4
