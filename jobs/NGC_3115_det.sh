#!/bin/bash
#SBATCH --job-name=NGC_3115_49nHz_det_20240314
#SBATCH --partition=day
#SBATCH --output=/home/bbl29/targeted_cws_ng15/logs/NGC_3115_49nHz_det_20240314.txt
#SBATCH --error=/home/bbl29/targeted_cws_ng15/logs/error/NGC_3115_49nHz_det_20240314.txt
#SBATCH --nodes=1
#SBATCH --ntasks=4
