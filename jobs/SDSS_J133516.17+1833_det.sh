#!/bin/bash
#SBATCH --job-name=SDSS_J133516.17+1833_20240917
#SBATCH --partition=scavenge
#SBATCH --output=/home/bbl29/targeted_cws_ng15/logs/SDSS_J133516.17+1833_20240917.txt
#SBATCH --error=/home/bbl29/targeted_cws_ng15/logs/error/SDSS_J133516.17+1833_20240917.txt
#SBATCH --nodes=1
#SBATCH --ntasks=4
