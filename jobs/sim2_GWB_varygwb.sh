#!/bin/bash
#SBATCH --job-name=sim2_no_cw_varygwb_20240304
#SBATCH --partition=day
#SBATCH --output=/home/bbl29/targeted_cws_ng15/logs/sim2_no_cw_varygwb_20240304.txt
#SBATCH --error=/home/bbl29/targeted_cws_ng15/logs/error/sim2_no_cw_varygwb_20240304.txt
#SBATCH --nodes=1
#SBATCH --ntasks=4
