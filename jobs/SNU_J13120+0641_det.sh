#!/bin/bash
#SBATCH --job-name=SNU_J13120+0641_det_20240314
#SBATCH --partition=day
#SBATCH --output=/home/bbl29/targeted_cws_ng15/logs/SNU_J13120+0641_det_20240314.txt
#SBATCH --error=/home/bbl29/targeted_cws_ng15/logs/error/SNU_J13120+0641_det_20240314.txt
#SBATCH --nodes=1
#SBATCH --ntasks=4
