#!/bin/bash
#SBATCH --job-name=PKS_J0805-0111_20240222
#SBATCH --partition=day
#SBATCH --output=/home/bbl29/targeted_cws_ng15/logs/PKS_J0805-0111_20240222.txt
#SBATCH --error=/home/bbl29/targeted_cws_ng15/logs/error/PKS_J0805-0111_20240222.txt
#SBATCH --nodes=1
#SBATCH --ntasks=4
