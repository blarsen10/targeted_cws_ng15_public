#!/bin/bash
#SBATCH --job-name=Gondor_varycrn_20250613
#SBATCH --partition=day
#SBATCH --exclude=r806u23n04
#SBATCH --output=/home/bbl29/targeted_cws_ng15/logs/Gondor_varycrn_20250613.txt
#SBATCH --error=/home/bbl29/targeted_cws_ng15/logs/error/Gondor_varycrn_20250613.txt
#SBATCH --nodes=1
#SBATCH --ntasks=4
