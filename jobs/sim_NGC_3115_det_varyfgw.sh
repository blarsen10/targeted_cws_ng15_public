#!/bin/bash
#SBATCH --job-name=sim_NGC_3115_det_varyfgw_20240411
#SBATCH --partition=pi_mingarelli
#SBATCH --exclude=r806u23n04
#SBATCH --output=/home/bbl29/targeted_cws_ng15/logs/sim_NGC_3115_det_varyfgw_20240411.txt
#SBATCH --error=/home/bbl29/targeted_cws_ng15/logs/error/sim_NGC_3115_det_varyfgw_20240411.txt
#SBATCH --nodes=1
#SBATCH --ntasks=4
