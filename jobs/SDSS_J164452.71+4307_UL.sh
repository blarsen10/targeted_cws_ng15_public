#!/bin/bash
#SBATCH --job-name=SDSS_J164452.71+4307_UL_20240322
#SBATCH --partition=pi_mingarelli
#SBATCH --exclude=r806u23n04
#SBATCH --output=/home/bbl29/targeted_cws_ng15/logs/SDSS_J164452.71+4307_UL_20240322.txt
#SBATCH --error=/home/bbl29/targeted_cws_ng15/logs/error/SDSS_J164452.71+4307_UL_20240322.txt
#SBATCH --nodes=1
#SBATCH --ntasks=4
