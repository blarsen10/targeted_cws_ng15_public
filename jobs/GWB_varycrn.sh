#!/bin/bash
#SBATCH --job-name=no_cw_varycrn_20240313
#SBATCH --partition=day
#SBATCH --output=/home/bbl29/targeted_cws_ng15/logs/no_cw_varycrn_20240313.txt
#SBATCH --error=/home/bbl29/targeted_cws_ng15/logs/error/no_cw_varycrn_20240313.txt
#SBATCH --nodes=1
#SBATCH --ntasks=4
