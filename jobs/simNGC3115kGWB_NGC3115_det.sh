#!/bin/bash
#SBATCH --job-name=simCW_kGWB_NGC_3115_det_varyfgw_20240730
#SBATCH --partition=pi_mingarelli
#SBATCH --exclude=r806u23n04
#SBATCH --output=/home/bbl29/targeted_cws_ng15/logs/simCW_kGWB_NGC_3115_det_varyfgw_20240730.txt
#SBATCH --error=/home/bbl29/targeted_cws_ng15/logs/error/simCW_kGWB_NGC_3115_det_varyfgw_20240730.txt
#SBATCH --nodes=1
#SBATCH --ntasks=4
