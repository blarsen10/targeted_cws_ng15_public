#!/bin/bash
#SBATCH --job-name=NGC_3115_det_dropJ1024_varyfgw_20240514
#SBATCH --partition=scavenge
#SBATCH --exclude=r806u23n04
#SBATCH --output=/home/bbl29/targeted_cws_ng15/logs/NGC_3115_det_dropJ1024_varyfgw_20240514.txt
#SBATCH --error=/home/bbl29/targeted_cws_ng15/logs/error/NGC_3115_det_dropJ1024_varyfgw_20240514.txt
#SBATCH --nodes=1
#SBATCH --ntasks=4
