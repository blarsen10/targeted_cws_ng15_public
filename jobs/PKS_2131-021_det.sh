#!/bin/bash
#SBATCH --job-name=PKS_2131-021_det_20240320
#SBATCH --partition=scavenge
#SBATCH --output=/home/bbl29/targeted_cws_ng15/logs/PKS_2131-021_det_20240320.txt
#SBATCH --error=/home/bbl29/targeted_cws_ng15/logs/error/PKS_2131-021_det_20240320.txt
#SBATCH --nodes=1
#SBATCH --ntasks=4
