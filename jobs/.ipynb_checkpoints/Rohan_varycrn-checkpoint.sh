#!/bin/bash
#SBATCH --job-name=Rohan_varycrn_20250613
#SBATCH --partition=scavenge
#SBATCH --exclude=r806u23n04
#SBATCH --output=/home/bbl29/targeted_cws_ng15/logs/Rohan_varycrn_20250613.txt
#SBATCH --error=/home/bbl29/targeted_cws_ng15/logs/error/Rohan_varycrn_20250613.txt
#SBATCH --nodes=1
#SBATCH --ntasks=4
