#!/bin/bash
#SBATCH --job-name={{SOURCE_NAME}}_det_{{DATE}}
#SBATCH --partition=pi_mingarelli
#SBATCH --exclude=r806u23n04
#SBATCH --output=/home/bbl29/targeted_cws_ng15/logs/{{SOURCE_NAME}}_det_{{DATE}}.txt
#SBATCH --error=/home/bbl29/targeted_cws_ng15/logs/error/{{SOURCE_NAME}}_det_{{DATE}}.txt
#SBATCH --nodes=1
#SBATCH --ntasks=4
