#!/bin/bash
#SBATCH --job-name=NGC_3115_49nHz_det_13h05m13.927s_-22d36m02.83082167s_20240506
#SBATCH --partition=pi_mingarelli
#SBATCH --exclude=r806u23n04
#SBATCH --output=/home/bbl29/targeted_cws_ng15/logs/NGC_3115_49nHz_det_13h05m13.927s_-22d36m02.83082167s_20240506.txt
#SBATCH --error=/home/bbl29/targeted_cws_ng15/logs/error/NGC_3115_49nHz_det_13h05m13.927s_-22d36m02.83082167s_20240506.txt
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
ra_dec=13h05m13.927s_-22d36m02.83082167s
orf=
