#!/bin/bash
#SBATCH --job-name=NGC_3115_49nHz_det_19h35m00s_-26d35m38.07567576s_20240506
#SBATCH --partition=pi_mingarelli
#SBATCH --exclude=r806u23n04
#SBATCH --output=/home/bbl29/targeted_cws_ng15/logs/NGC_3115_49nHz_det_19h35m00s_-26d35m38.07567576s_20240506.txt
#SBATCH --error=/home/bbl29/targeted_cws_ng15/logs/error/NGC_3115_49nHz_det_19h35m00s_-26d35m38.07567576s_20240506.txt
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
ra_dec=19h35m00s_-26d35m38.07567576s
orf=
