#!/bin/bash
#SBATCH --job-name=HS_0926+3608_det_20240320
#SBATCH --partition=scavenge
#SBATCH --output=/home/bbl29/targeted_cws_ng15/logs/HS_0926+3608_det_20240320.txt
#SBATCH --error=/home/bbl29/targeted_cws_ng15/logs/error/HS_0926+3608_det_20240320.txt
#SBATCH --nodes=1
#SBATCH --ntasks=4
