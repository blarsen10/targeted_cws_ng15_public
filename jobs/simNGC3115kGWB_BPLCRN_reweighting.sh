#!/bin/bash
#SBATCH --job-name=reweight_simNGC3115kGWB_BPLCRN_20240806
#SBATCH --partition=pi_mingarelli
#SBATCH --exclude=r806u23n04
#SBATCH --output=/home/bbl29/targeted_cws_ng15/logs/reweight_simNGC3115kGWB_BPLCRN_20240806.txt
#SBATCH --error=/home/bbl29/targeted_cws_ng15/logs/error/reweight_simNGC3115kGWB_BPLCRN_20240806.txt
#SBATCH --ntasks=1
