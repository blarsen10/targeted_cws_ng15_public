#!/bin/bash
#SBATCH --job-name=SDSS_J134855.27-0321_det_20240320
#SBATCH --partition=scavenge
#SBATCH --output=/home/bbl29/targeted_cws_ng15/logs/SDSS_J134855.27-0321_det_20240320.txt
#SBATCH --error=/home/bbl29/targeted_cws_ng15/logs/error/SDSS_J134855.27-0321_det_20240320.txt
#SBATCH --nodes=1
#SBATCH --ntasks=4
