...
outdir = chaindir+'/HS1630_det_CW_newfixCRN/'
...
def run_det(N):
    ...
    c = SkyCoord('16h33m02.664s', '+23d49m28.52s', frame='icrs')
    log_dist = np.log10(5268)
    log_f = np.log10(11.3e-9)
    freq = 11.3e-9
    ...
    log10_mc = parameter.Uniform(7,m_max)('log10_mc')
